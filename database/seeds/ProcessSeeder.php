...
class ProcessesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $process->ProcParticipantes = ['Subgerente', 'Director de Planta', 'Gerente General'];
        ...
        $process->gambientals()->sync(['1', '2', '3', '4']);
        $process->gseguridads()->sync(['1', '2', '3', '4', '5']);
        $process->requisitos()->sync(['1', '2', '3', '4', '5', '6']);
        $process->riesgos()->sync(['1', '2', '3', '4', '5', '6', '7', '8']);
